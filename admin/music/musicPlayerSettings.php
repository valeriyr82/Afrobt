...
$CFG['lang']['include_files'][] = 'languages/%s/music/admin/musicPlayerSettings.php';
...
$CFG['config_music_path'] = '../../common/configs/config_music_player.inc.php';
...
//$download_previlages_arr = array('All'=>$LANG['allow_all'], 'members'=>$LANG['registered_users']);
...
$editfilefrm->left_navigation_div = 'musicSetting';
//<<<<<---------------------Code ends------------------//
...
<?php
							...
							case 'boolean':
								switch($value['tags']['@cfg_key'])
									{
										case 'AutoPlay':
										case 'PlaylistPlayerAutoPlay':
										case 'PlaylistAutoPlay':
										case 'FutureListPlayerAutoPlay':
										case 'FuturePlayListPlayerAutoPlay':
										case 'QuickmixPlayerAutoPlay':
										case 'QuickmixPlaylistPlayerAutoPlay':
										case 'EmbedPlayerAutoPlay':
										case 'EmbedPlaylistPlayerAutoPlay':
?>
		<tr>
			<td class="clsFormLabelCellDefault"><?php $editfilefrm->renderLabelTableCell($value['tags']['@cfg_key'], $value['tags']['@cfg_label']); ?></td>
			<td class="clsFormFieldCellDefault">
				...
				<input class="clsCheckRadio" name="<?php echo $value['tags']['@cfg_key'];?>" id="<?php echo $value['tags']['@cfg_key'];?>" tabindex="<?php echo $tab_index;?>" type="radio" class="clsCheckRadio" value="false" <?php echo $editfilefrm->isCheckedRadio('false', $value['value']);?> />
