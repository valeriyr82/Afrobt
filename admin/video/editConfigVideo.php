...
$CFG['lang']['include_files'][] = 'languages/%s/video/admin/editConfigVideo.php';
...
$CFG['config_video_path'] = '../../common/configs/config_video.inc.php';
...
$full_length_video_arr = array('All'=>$LANG['allow_all'], 'members'=>$LANG['registered_users'],'paid_members'=>$LANG['paid_members']);
...
?>
		<tr>
			<td class="clsFormLabelCellDefault"><?php $editfilefrm->renderLabelTableCell($value['tags']['@cfg_key'], $value['tags']['@cfg_label']); ?></td>
			<td class="clsFormFieldCellDefault">
				<select name="full_length_video" id="full_length_video" tabindex="<?php echo $tab_index;?>">
					<?php $editfilefrm->populateArray($full_length_video_arr, $value['value']);?>
				</select>
			</td>
		</tr>
<?php
