 ...
 * @version		SVN: $Id: editConfigProfile.php 483 2006-10-26 03:21:42Z vidhya_29ag04 $
 * @since 		2006-10-16
 */
...
$CFG['lang']['include_files'][] = 'languages/%s/video/admin/editConfigEncoderCommand.php';
...
<?php
		 ...
		 * @access		public
		*/
		public function renderTextAreaLarge($type='',$name, $content,$tab_index)
			{
			$rows=3;
			$cols=85;
?>
<textarea name="<?php echo $name?>" id="<?php echo $name?>" rows="<?php echo $rows?>" cols="<?php echo $cols?>" tabindex="<?php echo $tab_index?>" style="width:99.5%;height:65px;"><?php echo $content; ?></textarea>
<?php
			}
...
$CFG['config_music_path'] = '../../common/configs/config_encoder_command.inc.php';
...
$editfilefrm->left_navigation_div = 'videoSetting';
...
<div id="selGeneralConfiguration1">
...
?>
<form name="form_config" id="selFormConfig" method="post" action="<?php echo getCurrentUrl();?>" autocomplete="off"  enctype="multipart/form-data" onsubmit="return chkMandatoryFields();">
<?php
	$tab_index = 1000;
	$prev_sec_name = '';
...
?>
	...
	<div class="clsConfigSectionHead">
		<?php echo $prev_sec_name;?>
		</div>
		<table class="clsNoBorder" summary="<?php echo $LANG['general_config_config_tbl_summary'];?>">
<?php
...
<?php
		...
		<tr>
			<td class="clsWidthMedium clsFormLabelCellDefault"><?php $editfilefrm->renderLabelTableCell($value['tags']['@cfg_key'], $value['tags']['@cfg_label']); ?></td>
			<td class="clsFormFieldCellDefault"><?php $editfilefrm->renderTextAreaLarge($input_type, $value['tags']['@cfg_key'], $value['value'], $tab_index);?><?php eval($result);?></td>
		</tr>
<?php
											break;
