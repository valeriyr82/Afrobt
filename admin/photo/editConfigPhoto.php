...
/**
 * To edit the config_photo file
 *
 * TO show the config_photo variables from the file and edit
 *
 * PHP version 5.0
 *
 * @category	Cann
 ...
 * @version		SVN: $Id: editConfigPhoto.php
 * @since 		2006-10-16
 */
...
$CFG['lang']['include_files'][] = 'languages/%s/photo/admin/editConfigPhoto.php';
...
$CFG['config_photo_path'] = '../../common/configs/config_photo.inc.php';
...
//ADDED THE ARRAY FOR ALLOWED TYPE TO UPLOAD THE PHOTO
...
$editfilefrm->getFileContent($CFG['config_photo_path']);
						...
						if ($start_of_comment !== false and
								$end_of_comment !== false)
							{
							...
							else
								{
									...
									$fw = fopen($CFG['config_photo_path'], 'w');
...
$editfilefrm->left_navigation_div = 'photoSetting';
//<<<<<---------------------Code ends------------------//
...
if ($editfilefrm->isShowPageBlock('show_config_variable'))
	{
		...
		$config_content = '';
		$ret_array = array();
		$config_content  = file_get_contents($CFG['config_photo_path']);
