...
{/if}
		...
		<div id="selWidget">
		   	<div class="clsCommonIndexRoundedCorner"> <!--rounded corners-->
                ...
                {include file='box.tpl' opt='bestsolution_top'}
                	<!-- tabs start -->
					<div class="clsBestBoardLink sectionHeading clsOverflow ">
						<div class="clsSectionHeadingLeft"><h2>{$LANG.discuzz_common_best_boards}</h2></div>
                        <div class="clsSectionHeadingRight pagination" id="paginate-slider1"></div>
					</div>
					<!-- tabs end -->
	...
	<div class="clsBoardsLink sectionHeading clsOverflow">
		<div class="clsSectionHeadingLeft"><h2>
