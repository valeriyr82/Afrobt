<?php
/**
 * View all topic created in a forum title
 *
 * PHP version 5.0
 *
 * @category	Discuzz
 * @package		forumsResponsesFormHandler
...
$CFG['lang']['include_files'][] = 'languages/%s/'.$CFG['admin']['index']['home_module'].'/discussionSearch.php';
...
require_once('general/discussionSearch.php');
?>