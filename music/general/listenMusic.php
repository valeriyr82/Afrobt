				...
				if($this->getFormField('music_ext'))
					{
						...
						<?
						...
						else
							{
								...
								$this->getOtherFormatTotalDownload($this->getFormField('music_ext'), $this->getFormField('music_id'))?'('.$total_original_format_downloads:' (0'); echo ' '.$this->LANG['viewmusic_downloads'].')'; ?></a></li><?
							}
					}
			}
