<?php /* Smarty version 2.6.18, created on 2012-09-07 08:09:23
...
<div class="clsWhatgoingHeading clsOverflow">
    ...
    <div class="clsWhatgoingRightTab" id="indexActivitesTabs">
        <ul class="clsFloatRight">
        	<?php if (isMember ( )): ?>
            <li><a href="?activity_type=My" title="<?php echo $this->_tpl_vars['LANG']['sidebar_my_label']; ?>
"><span><?php echo $this->_tpl_vars['LANG']['sidebar_my_label']; ?>
</span></a></li>
            <li><a href="?activity_type=Friends" title="<?php echo $this->_tpl_vars['LANG']['sidebar_friends_label']; ?>
"><span><?php echo $this->_tpl_vars['LANG']['sidebar_friends_label']; ?>
</span></a></li>
            <?php endif; ?>
            <li><a href="?activity_type=All" title="<?php echo $this->_tpl_vars['LANG']['sidebar_everyone_label']; ?>
