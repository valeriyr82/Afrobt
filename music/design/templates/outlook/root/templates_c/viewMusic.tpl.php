...
: <span><?php echo $this->_tpl_vars['myobj']->getFormField('cur_mid_play_time'); ?>
										...
										<span class="clsDownloadTrackLeft"><span class="clsDownloadTrackRight"><a onclick="return Confirmation('downloadFormat', '', Array(), Array(), Array(), 50, 190, 'anchor_music_download_block')"><?php echo $this->_tpl_vars['LANG']['viewmusic_download']; ?>
</a></span></span>
                                        <?php endif; ?>
									</div>
								</div>
