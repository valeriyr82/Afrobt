...
<div class="clsWhatgoingHeading clsOverflow">
    ...
    <div class="clsWhatgoingRightTab" id="indexActivitesTabs">
        <ul class="clsFloatRight">
        	{if isMember()}
            <li><a href="?activity_type=My" title="{$LANG.sidebar_my_label}"><span>{$LANG.sidebar_my_label}</span></a></li>
            <li><a href="?activity_type=Friends" title="{$LANG.sidebar_friends_label}"><span>{$LANG.sidebar_friends_label}</span></a></li>
            {/if}
            <li><a href="?activity_type=All" title="{$LANG.sidebar_everyone_label}"><span>{$LANG.sidebar_everyone_label}</span></a></li>
        </ul>
    </div>
