...
<div class="clsIndexAudioContainer" id="indexAudioContainer">
    <div class="clsJQCarousel" id="musicListTabs">
		<div class="clsJQCarouselHead"><h3>{$LANG.sidebar_audio_label}</h3></div>
        <ul class="clsJQCarouselTabs clsOverflow">
            <li id="newmusic_Head"><a href="?showtab=newmusic&limit={$music_limit_per_page}" title="{$LANG.sidebar_recently_upldated_label}"><span>{$LANG.sidebar_recently_upldated_label}</span></a></li>
            <li id="topratedmusic_Head"><a href="?showtab=topratedmusic&limit={$music_limit_per_page}" title="{$LANG.sidebar_top_rating_label}"><span>{$LANG.sidebar_top_rating_label}</span></a></li>
        </ul>
    </div>
</div>
<script type="text/javascript">
	var music_index_ajax_url = '{$CFG.site.music_url}';
