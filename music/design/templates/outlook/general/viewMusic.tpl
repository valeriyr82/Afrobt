<div class="clsViewAudioPage padding10">
							...
							<div class="clsPlayerEmbed">
								...
								<div class="clsEmbedTop clsOverflow">
									...
									<div class="clsTrackDownload">
										...
										<span class="clsDownloadTrackLeft"><span class="clsDownloadTrackRight"><a onclick="return Confirmation('downloadFormat', '', Array(), Array(), Array(), 50, 190, 'anchor_music_download_block')">{$LANG.viewmusic_download}</a></span></span>
                                        {/if}
									</div>
								</div>
