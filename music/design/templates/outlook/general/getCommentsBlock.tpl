    ...
    <form name="addComments" id="addComments" method="post" action="{$myobj->getCurrentUrl()}" autocomplete="off" onsubmit="return false">
        ...
        {/if}
            <table>
                <tr>
                    <td>
                        <textarea class="clsEmbedTextFields clsPlaylistCommentsBlock" name="comment" id="comment" tabindex="{smartyTabIndex}" rows="5" cols="60"></textarea>
                    </td>
                </tr>
