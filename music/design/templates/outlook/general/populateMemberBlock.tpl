...
{if $opt == 'music'}
     <div class="clsAudioIndex clsCategoryHd clsIndexMyMusicContainer">
            <span class="clsWhatgoingHeading">{$LANG.sidebar_mymusic_dashboard_label}</span>
...
{elseif $opt == 'playlist'}
     <div class="clsAudioIndex clsCategoryHd" >
        <span class="clsWhatgoingHeading">{$LANG.sidebar_music_playlist_quickmixblock_label}</span>
