...
<div class="ClsTopChartListCarouselContainer">
    ...
    <div class="clsIndexViewAllLinks">
			<a title="{$LANG.myhome_music_view_all_albums}" href="{$myobj->view_all_albums_url}" class="viewmore">{$LANG.myhome_music_view_all_albums}</a>
	</div>
    {else}
	<div class="clsIndexViewAllLinks">
			<a title="{$LANG.myhome_music_view_all_music}" href="{$myobj->view_all_music_url}" class="viewmore">{$LANG.myhome_music_view_all_music}</a>
	</div>
    {/if}
</div>
<script type="text/javascript">
