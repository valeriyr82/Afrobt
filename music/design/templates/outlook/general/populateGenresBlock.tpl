...
{include file="box.tpl" opt="sidebar_top"}
    <div class="clsAudioIndex clsCategoryHd clsindexCategriesBlock">
        <span class="clsWhatgoingHeading">{$LANG.sidebar_genres_heading_label}</span>
        {if $populateGenres_arr.record_count}
        	...
        	<p class="clsViewMore"><a href="{$moregenres_url}" title="{$LANG.sidebar_more_label}" class="viewmore">{$LANG.sidebar_view_all_category}</a></p>
        {else}	
