...
<table >
    <tr
        <td>
                <textarea name="comment_{$commentEditReply.comment_id}" id="comment_{$commentEditReply.comment_id}" rows="5" cols="92">{$myobj->getComment()}</textarea>
            </td>
    </tr>
    <tr>
        <td colspan="2">
		<div class="clsButtonHolder clsPaddingLeft10">
                ...
                <p class="clsDeleteButton" ><span><input class="clsCommentDiscard" type="button" onClick="return {$commentEditReply.cancelFunction}({$commentEditReply.comment_id})" name="cancel" id="cancel" tabindex="{smartyTabIndex}" value="{$LANG.postcomment_cancel}" /></span></p>
				</div>
            </td>
    </tr>
</table>
