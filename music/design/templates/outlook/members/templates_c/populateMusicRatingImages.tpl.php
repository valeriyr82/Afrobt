<?php /* Smarty version 2.6.18, created on 2012-09-05 05:38:16
         compiled from populateMusicRatingImages.tpl */ ?>
<?php if ($this->_tpl_vars['populateRatingImages_arr']['condition']): ?>
	<a href="<?php echo $this->_tpl_vars['populateRatingImages_arr']['url']; ?>
" id="ratingLink" alt="<?php echo $this->_sections['rating']['index']; ?>
">
<?php endif; ?>
...
" alt="<?php echo $this->_sections['rating']['index']; ?>
"/>
    <?php else: ?>
		<img src="<?php echo $this->_tpl_vars['populateRatingImages_arr']['bulet_star']; ?>
" alt="<?php echo $this->_sections['rating']['index']; ?>
" onclick="memberBlockLoginConfirmation('<?php echo $this->_tpl_vars['LANG']['common_rate_login_err_message']; ?>
','<?php echo $this->_tpl_vars['populateRatingImages_arr']['url']; ?>
');return false;"/>
	<?php endif; ?>
<?php endfor; endif; ?>
...
" alt="<?php echo $this->_sections['unrating']['index_next']; ?>
"/>
     <?php else: ?>
		<img src="<?php echo $this->_tpl_vars['populateRatingImages_arr']['bulet_star_empty']; ?>
" alt="<?php echo $this->_sections['unrating']['index_next']; ?>
