...
<!-- Footer -->
  ...
  <div id="footer">
<div class="clsInstallFooter clsLicenceFooter">
<div class="lbfooter">
  <div class="rbfooter">
    <div class="bbfooter">
      <div class="blcfooter">
          ...
          <div class="tbfooter">
            <div class="tlcfooter">
              <div class="trcfooter">
                  <table>
                      <tr>
                        <td  class="clsCopyright"> <p>&copy; <?php echo $CFG['admin']['coppy_rights_year'].' '.$CFG['site']['name'].'. '.$LANG['header_all_rights_reserved'].'.'; ?></p></td>
                        <td class="clsPoweredByAgriya"><span class="clsPoweredText">Powered By <a target="_blank" href="<?php echo $CFG['dev']['url']; ?>"><?php echo $CFG['dev']['name']; ?></a></span></td>
                      </tr>
                    </table>
    </div></div>
            </div>
