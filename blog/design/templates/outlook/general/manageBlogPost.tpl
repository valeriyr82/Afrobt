...
<div id="selBlogWriting" class="clsPageHeading">
	<div class="clsOverflow sectionHeading"><div class="clsSectionHeadingLeft"><h2>{if $myobj->chkIsEditMode()} {$LANG.manageblogpost_edit_title} {else} {$LANG.manageblogpost_title} {/if}</h2></div>
	{if $myobj->chkIsEditMode()}<div class="clsSectionHeadingRight"></div>{/if}</div>
