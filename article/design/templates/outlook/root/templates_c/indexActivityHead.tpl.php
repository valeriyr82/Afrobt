...
<div class="clsWhatgoingHeading clsOverflow">
	<h3><?php echo $this->_tpl_vars['LANG']['sidebar_activities_label']; ?>
</h3>
    <div class="clsWhatgoingRightTab" id="indexActivitesTabs">
        <ul class="clsFloatRight">
            ...
            <?php endif; ?>
            <li><a href="index.php?activity_type=All"><span><?php echo $this->_tpl_vars['LANG']['sidebar_articleactivity_all_label']; ?>
</span></a></li>
        </ul>
    </div>
