<div id="selArticleList">
	...
	<form id="seachAdvancedFilter" name="seachAdvancedFilter" method="post" action="{$myobj->getCurrentUrl()}" autocomplete="off">
    	...
    	<div class="clsOverflow sectionHeading">
      		<div class="clsSectionHeadingLeft">
        		<h2>
      		...
      		<div class="clsSectionHeadingRight">
    ...
    {if $myobj->isShowPageBlock('form_show_sub_category')}
    	<div class="clsAdvancedFilterSearch clsShowHideFilter" id="">
        	<a href="javascript:void(0)" id="show_link" class="clsShow clsShowFilterSearch"  {if $myobj->chkAdvanceResultFound()}  style="display:none" {/if} onclick="divShowHide('showHideSubCategory', 'show_link', 'hide_link')"><span>{$LANG.articlelist_showarticle_subcategory}</span></a>
            <a href="javascript:void(0)" id="hide_link" {if !$myobj->chkAdvanceResultFound()}  style="display:none" {/if} class="clsHide clsHideFilterSearch"  onclick="divShowHide('showHideSubCategory', 'show_link', 'hide_link')"><span>{$LANG.articlelist_hidearticle_subcategory}</span></a>
        </div>
        {$myobj->setTemplateFolder('general/','article')}
