...
<div class="clsCarouselContainer">
	<div class="clsIndexViewAll">
    	...
    	<div class="clsIndexViewAllLinks">
    		<a href="{$myobj->getUrl('photoslidelist', '?pg=slidelistnew', 'slidelistnew/', '', 'photo')}" title="{$LANG.index_photo_view_all_slidelist}" class="viewmore">{$LANG.index_photo_view_all_slidelist}</a>
    	</div>
    </div>
</div>
