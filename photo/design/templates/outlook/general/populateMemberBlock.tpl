{if $opt == 'photo'}
     <div class="clsSideBarContent clsCategoryHd">
            ...
            <div class="clsOverflow"><span class="clsRightBarWidgetTitle">{$LANG.sidebar_myphoto_dashboard_label|truncate:25}</span></div>
...
{elseif $opt == 'slidelist'}
     <div class="clsSideBarContent clsCategoryHd" >
		{$myobj->setTemplateFolder('general/','photo')}
        {include file="box.tpl" opt="sidebar_top"}
	<div class="clsOverflow"><span class="clsRightBarWidgetTitle">{$LANG.sidebar_playlist_quickmixblock_label}</span></div>
