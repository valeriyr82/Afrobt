...
<div class="clsJQCarouselHead">
    <h3>{$LANG.sidebar_photo_channel_label}</h3>
</div>
{if $total_category}
	    ...
	    <div class="clsCarouselContainer">
	    	<div class="clsIndexViewAll">
	    		...
	    		<div class="clsIndexViewAllLinks">
	    			<a href="{$myobj->getUrl('photocategory', '', '', '', 'photo')}" title="{$LANG.index_photo_view_all_categories}" class="viewmore">{$LANG.index_photo_view_all_categories}</a>
	    		</div>
	    	</div>
		</div>
	</div>
