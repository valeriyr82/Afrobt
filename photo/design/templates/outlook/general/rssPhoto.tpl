...
{include file='box.tpl' opt='display_top'}
	...
	{if $myobj->isShowPageBlock('rssListBlock') }		
		<div class="clsDataTable clsMembersBrowseTable">		
		  <p class="clsMemberDetailsTitle">{$LANG.photo}</p>
           <div class="clsBrowseMembersDetails">
            <table summary="{$LANG.tbl_summary}">
			<tr>
				<td class="clsSelectSmall">{$LANG.recently_added}</td>
				<td class="clsRssSmall"><a href="{$myobj->getRssUrl('recentlyAdded')}"><img src="{$CFG.site.url}design/templates/{$CFG.html.template.default}/images/rss.gif" /></a></td>	
		...
		<div class="clsDataTable clsMembersBrowseTable">
         <p class="clsMemberDetailsTitle">{$LANG.most_viewed_photos}</p>
          <div class="clsBrowseMembersDetails">
           <table summary="{$LANG.tbl_summary}">
			<tr>
				<td class="clsSelectSmall">{$LANG.today}</td>
				<td class="clsRssSmall"><a href="{$myobj->getRssUrl('todayMostViewed')}"><img src="{$CFG.site.url}design/templates/{$CFG.html.template.default}/images/rss.gif" /></a></td>
				{if $CFG.rss_display.yahoo}
		...
		<div class="clsDataTable clsMembersBrowseTable">
		 <p class="clsMemberDetailsTitle">{$LANG.most_discussed_photos}</p>
          <div class="clsBrowseMembersDetails">
           <table summary="{$LANG.tbl_summary}">
			<tr>
				<td class="clsSelectSmall">{$LANG.today}</td>
				<td class="clsRssSmall"><a href="{$myobj->getRssUrl('todayMostDiscussed')}"><img src="{$CFG.site.url}design/templates/{$CFG.html.template.default}/images/rss.gif" /></a></td>
				{if $CFG.rss_display.yahoo}
