...
{* PHOTO STACK SECTION STARTS *}
{$myobj->getQuickMixLastImg()}
{if $display_stach_block}
{literal}
<script type="text/javascript">
photo_stack = { "photo_ids":[{/literal}{$photo_ids}],"url":"{$session_last_img_url}","hide_tip":true {literal}};
$Jq(document).ready(function(){ updatePhotoStack(true);});
</script>
{/literal}
{/if}
{* PHOTO STACK SECTION ENDS *}
