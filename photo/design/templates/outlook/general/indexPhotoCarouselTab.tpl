    ...
    <div class="clsIndexViewAll">
    	...
    	<div class="clsIndexViewAllLinks">
    		{if $showtab eq 'mostrecentphoto'}
				<a href="{$myobj->getUrl('photolist','?pg=photonew','photonew/','','photo')}" title="{$LANG.index_photo_view_all_photos}" class="viewmore">{$LANG.index_photo_view_all_photos}</a>
			{elseif $showtab eq 'topratedphoto'}
				<a href="{$myobj->getUrl('photolist','?pg=phototoprated','phototoprated/','','photo')}" title="{$LANG.index_photo_view_all_photos}" class="viewmore">{$LANG.index_photo_view_all_photos}</a>
			{/if}
		</div>
	</div>
</div>
