...
<div class="clsWhatgoingHeading clsOverflow">
	<span class="clsRightBarWidgetTitle">{$LANG.sidebar_photo_activities_label}</span>
    <div class="clsRightBarWidgetTab" id="indexActivitesTabs">
        <ul class="clsFloatRight">
            ...
            {/if}
            <li><a href="index.php?activity_type=All">{$LANG.sidebar_photoactivity_all_label}</a></li>
        </ul>
    </div>
