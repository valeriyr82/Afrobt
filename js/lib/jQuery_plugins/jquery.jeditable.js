    ...
    $Jq.fn.editable = function(target, options) {
        ...
        return this.each(function() {
            ...
            $Jq(this).bind(settings.event, function(e) {
                ...
                //ADDED BY AGRIYA TO fix THE ISSUE ON CLICKING THE INDICATOR
                    ...
                    if (false !== onsubmit.apply(form, [settings, self])) {
                        ...
                        if (false !== submit.apply(form, [settings, self])) {
                          ...
                          if ($Jq.isFunction(settings.target)) {
                              ...
                              //AGRIYA COMMENTED THE FOLLOWING LINE AND ADDED THE NEXT LINE TO SHOW THE LOADING GIF
                             // $Jq(self).html(str);
...
//agriya: Create a custom input type for checkboxes
