		...
		public function populateStaticRatingImages($rating, $media_type='video')
			{
                ...
                ?>
                <?php for($i=1; $i<=$rating; $i++) { ?>
                    <img id="img<?php echo $i.$media_type;?>" src="<?php echo $this->CFG['site']['imageurl'] ?>icon-gliderratehover.gif"  title="<?php echo $i;?>" />
                <?php } ?>
                <?php for($i=$rating; $i<$rating_total; $i++) { ?>
                    <img id="img<?php echo ($i+1).$media_type;?>" src="<?php echo $this->CFG['site']['imageurl'] ?>icon-gliderrate.gif" title="<?php echo ($i+1);?>" />
                <?php } ?>
                <?php
			}
		/**
