...
{include file='box.tpl' opt='display_top'}
	<div class="clsPageHeading  clsOverflow"><h2><span>{$LANG.profileblog_title}</span></h2></div>
...
{/if}
        ...
        <div class="clsOverflow clsPopupBlogHeadingContainer"><div class="clsPopUpWindowHeading clsPopupBlogHeading">
			<h2 id="confirmation_msg" class="clsPopUpHeading"></h2></div>
				<!--<div class="clsCloseWindowContainer"><a class="clsCloseWindow" href="javascript:void(0)" onclick="closeAddBlog();">{$LANG.profileblog_close}</a></div> --></div>
        ...
        {include file='box.tpl' opt='popupvideo_bottom'}
             ...
             <div>
              {if $myobj->getFormField('video_id') != ''}
                    <p>
                        <a href="{$myobj->view_video_url}">{$LANG.profileblog_back}</a>
                    </p>
              {/if}
             </div>
