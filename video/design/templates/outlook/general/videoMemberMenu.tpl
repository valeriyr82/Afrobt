...
<div class="clsSideBarLinks">
	<div class="clsSideBar">
    	<div class="clsOverflow">
            <div class="clsRightBarWidgetTitle">{$LANG.header_nav_video_my_dash_board_videos}</div>
        </div>
...
<div class="clsSideBarLinks">
	<div class="clsSideBar">
    	<div class="clsSideBarLeft">
            <div class="clsRightBarWidgetTitle">{$LANG.header_nav_video_manage_video_my_playlist_quicklinks_title}</div>
        </div>
    	<div class="clsSideBarRight">
        	<div class="clsSideBarContent">
    			<ul>
