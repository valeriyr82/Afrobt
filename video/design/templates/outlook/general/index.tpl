<!--SIDEBAR-->
	...
	<div class="clsWhatgoingHeading clsOverflow">
        <div class="clsRightBarWidgetTitle">{$LANG.header_nav_whats_goingon_activity_title_lbl}</div>
		<div class="clsFloatLeft clsTagsRightTab" id="indexActivitesTabs">
			<ul class="clsRightBarWidgetTab">
			{if isMember()}
				<li><a href="?activity_type=My">{$LANG.header_nav_whats_goingon_activity_my}</a></li>
				<li><a href="?activity_type=Friends">{$LANG.header_nav_whats_goingon_activity_friends}</a></li>
			{/if}
				<li><a href="?activity_type=All">{$LANG.header_nav_whats_goingon_activity_all}</a></li>
			</ul>
		</div>
	</div>
