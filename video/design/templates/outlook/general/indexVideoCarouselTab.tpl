...
<div class="clsCarouselContainer">
	...
	<div class="clsViewMoreChannels"><a href="{$videoIndexObj->getUrl('videolist', '?pg=videonew', 'videonew/','','video')}" class="viewmore">{$LANG.index_page_video_block_viewall_link}</a></div>
</div>
