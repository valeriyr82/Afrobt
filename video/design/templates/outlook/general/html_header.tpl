    ...
    <div class="clsHeaderShadowImage">
        ...
        <div class="clsHeaderBlock">
            <div class="clsMainLogo">
                <h1>
                    <a href="{$header->index_page_link}" style="background-image:url({$header->logo_url});" title="{$CFG.site.name}" alt="{$CFG.site.name}">&nbsp;</a>
                </h1>
...
</div>{if $header->isUserStyle()}<div class="clsBodyContent profileBodyContent">{else}<div class="clsBodyContent">{/if}
<div class="clsVideoTopHeadingDetails">
	<div class=" clsOverflow">
	<div class="clsHeadTopVideoLeft">
	...
	<div class="clsHeadTopVideoRight">
...
{else}
<div id="main" class="{$CFG.main.class_name} {$header->headerBlock.banner.class} fullwidth">
{/if}
<!-- Header ends -->
