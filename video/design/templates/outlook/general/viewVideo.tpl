...
<div id="selViewVideo" class="padding10" style="margin-top:{$myobj->background_offset}px">
{php}}
else{{/php}
<div id="selViewVideo" class="padding10">
{php}}
{/php}
    ...
    {if $myobj->isShowPageBlock('videoMainBlock')}
        ...
        {*  External embeded site list  starts here *}
         {if !$myobj->checkIsExternalEmebedCode()}
          ...
          {/if}
       {*  External embeded site list  ends here *}
