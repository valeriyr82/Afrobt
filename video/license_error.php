...
<!-- Footer -->
  ...
  <div id="footer">
    <div class="clsInstallFooter">
      <p>&copy; <?php echo $CFG['admin']['coppy_rights_year'].' '.$CFG['site']['name'].'. '.$LANG['header_all_rights_reserved'].'.'; ?></p>
      <p class="clsInstallPoweredText"><span class="clsPoweredText">Powered By <a target="_blank" href="<?php echo $CFG['dev']['url']; ?>"><?php echo $CFG['dev']['name']; ?></a></span></p>
    </div>
  </div>
</body>
</html>