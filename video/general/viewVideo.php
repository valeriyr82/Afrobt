		...
		if($this->CFG['user']['user_id']!=$this->fields_arr['user_id'])
            ...
            $type=$this->getFormField('video_ext');
				...
				<?
					...
					{
						?><li><a target="_blank" class="cls<?php if(in_array($type, $video_download_format_arr)) echo $type; else echo 'playerdownloaddefault'; ?>"   href="<?php echo getUrl($this->getDownloadFileName(),'?video_id='.$this->getFormField('video_id').'&amp;video_type=original', 'original/'.$this->getFormField('video_id').'/','members','video');?>" title="<?php echo $this->getVideoDownLoadDetails($type); ?>" ><?php echo $this->getFormField('video_ext');  ?></a></li><?
					}
				}
			//	}
		}
			...
			?><li>
				<?
					...
					?><a target="_blank"  class="cls<?php if(in_array($type, $video_download_format_arr)) echo $type; else echo 'playerdownloaddefault'; ?>" href="<?php echo getUrl($this->getDownloadFileName(),'?video_id='.$this->fields_arr['video_id'].'&amp;video_type='.$type, $type.'/'.$this->fields_arr['video_id'].'/',$folder,'video');?>" title="<?php echo $this->getVideoDownLoadDetails($type); ?>" ><?php echo $type ?></a>
						<? //echo '<br/><span>('.$this->LANG['viewvideo_savetarget'].')</span>';
					}
					else
					{
						?><a target="_blank" class="cls<?php if(in_array($type, $video_download_format_arr)) echo $type; else echo 'playerdownloaddefault'; ?>" href="<?php echo getUrl($this->getDownloadFileName(),'?video_id='.$this->getFormField('video_id').'&amp;video_type='.$type, $type.'/'.$this->getFormField('video_id').'/','members','video');?>" title="<?php echo $this->getVideoDownLoadDetails($type); ?>" ><?php echo $type ?></a><?
					}
			//	}
				?></li>
			<?
