...
<div class="clsPagingList">
	<ul>
		...
		{ if $smarty_paging_list.first.start}
			<li class="clsFirstPageLink"><a href="{$smarty_paging_list.previous.href}" onclick="return {$smarty_paging_list.previous.onclick}"><span>{$smarty_paging_list.previous.display_text}</span></a></li>
		{else}
			<li class="clsInactiveFirstPageLink clsInActivePageLink"><span>{$smarty_paging_list.previous.display_text}</span></li>
		{/if}
		<!-- paging list start -->
		{foreach key=key item=start from=$smarty_paging_list.list.start}
			{ if $smarty_paging_list.list.start.$key}
				<li class="clsPagingLink"><a href="{$smarty_paging_list.list.href.$key}" onclick="return {$smarty_paging_list.list.onclick.$key}"><span>{$smarty_paging_list.list.display_text.$key}</span></a></li>
			{else}
		...
		{else}
			<li class="clsInactiveLastPageLink clsInActivePageLink"><span>{$smarty_paging_list.next.display_text}</span></li>
		{/if}
		<!-- Next link -->
