...
{if !$myobj->isShowPageBlock('form_list_top_friends')}
    {if $myobj->isCurrentUser()}
        ...
        <div class="clsOverflow sectionHeading"><div class="clsSectionHeadingLeft"><h2>{$myobj->page_title}</h2></div><div class="clsSectionHeadingRight"><h2><a href="{$myobj->getUrl('membersinvite', '', '', 'members')}">{$LANG.viewfriends_title_invite}</a></h2></div></div>
          {else}
