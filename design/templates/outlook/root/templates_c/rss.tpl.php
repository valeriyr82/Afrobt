<?php /* Smarty version 2.6.18, created on 2012-09-05 05:18:14
...
unset($_smarty_tpl_vars);
 ?>
	<?php if ($this->_tpl_vars['myobj']->isShowPageBlock('rssListBlock')): ?>		
		<div class="clsDataTable clsHeadingLeft"><table summary="<?php echo $this->_tpl_vars['LANG']['tbl_summary']; ?>
">
			<tr>
				<th colspan="4"><?php echo $this->_tpl_vars['LANG']['video']; ?>
</th>
			</tr>
			<tr>
				<td class="clsWidth150"><?php echo $this->_tpl_vars['LANG']['recently_added']; ?>
</td>
				<td><a href="<?php echo $this->_tpl_vars['myobj']->getRssUrl('recentlyAdded'); ?>
...
">
			<tr>
				<th colspan="4"><?php echo $this->_tpl_vars['LANG']['most_viewed_videos']; ?>
</th>
			</tr>
			<tr>
				<td class="clsWidth150"><?php echo $this->_tpl_vars['LANG']['today']; ?>
</td>
				<td><a href="<?php echo $this->_tpl_vars['myobj']->getRssUrl('todayMostViewed'); ?>
"><img src="<?php echo $this->_tpl_vars['CFG']['site']['url']; ?>
design/templates/<?php echo $this->_tpl_vars['CFG']['html']['template']['default']; ?>
/images/rss.gif" /></a></td>
				<?php if ($this->_tpl_vars['CFG']['rss_display']['yahoo']): ?>
...
">
			<tr>
				<th colspan="4"><?php echo $this->_tpl_vars['LANG']['most_discussed_videos']; ?>
</th>
			</tr>
			<tr>
				<td class="clsWidth150"><?php echo $this->_tpl_vars['LANG']['today']; ?>
</td>
				<td><a href="<?php echo $this->_tpl_vars['myobj']->getRssUrl('todayMostDiscussed'); ?>
"><img src="<?php echo $this->_tpl_vars['CFG']['site']['url']; ?>
design/templates/<?php echo $this->_tpl_vars['CFG']['html']['template']['default']; ?>
/images/rss.gif" /></a></td>
				<?php if ($this->_tpl_vars['CFG']['rss_display']['yahoo']): ?>
