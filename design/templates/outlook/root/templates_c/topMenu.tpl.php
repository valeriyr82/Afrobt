...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'lower', 'topMenu.tpl', 76, false),)), $this); ?>
   	...
   	<?php if (! isMember ( )): ?>
       	<?php if ($this->_tpl_vars['header']->chkAllowedModule ( array ( 'login' ) )): ?>
       		<?php if (((is_array($_tmp=$this->_tpl_vars['CFG']['html']['current_script_name'])) ? $this->_run_mod_handler('lower', true, $_tmp) : smarty_modifier_lower($_tmp)) != 'login'): ?>
                <li class="clsBlock clsFacebookLogin"><a class="clsBlock" href="/facebooklogin" alt="Login with Facebook" title="Login with Facebook"></a></li>
                <li class="clsBlock clsTwitterLogin"><a class="clsBlock" href="#" alt="Login with Twitter" title="Login with Twitter"></a></li>
