<?php /* Smarty version 2.6.18, created on 2012-09-05 03:34:35
         compiled from loginpopup.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'smartyTabIndex', 'loginpopup.tpl', 38, false),)), $this); ?>
...
</span><label for="head_user_name"><?php echo $this->_tpl_vars['myobj']->form_login['login_field_label']; ?>
</label></td>
						<td class="<?php echo $this->_tpl_vars['myobj']->getCSSFormFieldCellClass('user_name'); ?>
">
							<?php if (! isset ( $this->_tpl_vars['opt'] )): ?>
								<input type="text" class="clsTextBox" name="head_user_name" id="head_user_name" tabindex="<?php echo smartyTabIndex(array(), $this);?>
" value="<?php echo $this->_tpl_vars['myobj']->getFormField('user_name'); ?>
" maxlength="<?php echo $this->_tpl_vars['CFG']['fieldsize']['username']['max']; ?>
" />
							<?php else: ?>
								<input type="text" class="clsTextBox" name="head_user_name" id="head_user_name" tabindex="800" value="<?php echo $this->_tpl_vars['myobj']->getFormField('user_name'); ?>
" maxlength="<?php echo $this->_tpl_vars['CFG']['fieldsize']['username']['max']; ?>
" />
							<?php endif; ?>
...
"><span class="clsMandatoryFieldIcon"><?php echo $this->_tpl_vars['LANG']['common_mandatory_field_icon']; ?>
</span><label for="head_password"><?php echo $this->_tpl_vars['LANG']['common_password']; ?>
</label></td>
						<td class="<?php echo $this->_tpl_vars['myobj']->getCSSFormFieldCellClass('password'); ?>
">
							<?php if (! isset ( $this->_tpl_vars['opt'] )): ?>
								<input type="password" class="clsTextBox" name="head_password" id="head_password" tabindex="<?php echo smartyTabIndex(array(), $this);?>
" value="<?php echo $this->_tpl_vars['myobj']->getFormField('head_password'); ?>
" maxlength="<?php echo $this->_tpl_vars['CFG']['fieldsize']['password']['max']; ?>
" />
							<?php else: ?>
								<input type="password" class="clsTextBox" name="head_password" id="head_password" tabindex="805" value="<?php echo $this->_tpl_vars['myobj']->getFormField('password'); ?>
" maxlength="<?php echo $this->_tpl_vars['CFG']['fieldsize']['password']['max']; ?>
" />
							<?php endif; ?>
