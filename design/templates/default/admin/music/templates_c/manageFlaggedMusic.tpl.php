<?php /* Smarty version 2.6.18, created on 2012-09-05 05:35:48
         compiled from manageFlaggedMusic.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'smartyTabIndex', 'manageFlaggedMusic.tpl', 9, false),)), $this); ?>
<div id="selMusicList">
...
?>
        ...
        <?php endforeach; endif; unset($_from); ?>
           <form name="flagmusicForm" id="flagmusicForm" method="post" action="<?php echo $this->_tpl_vars['myobj']->getCurrentUrl(); ?>
" autocomplete="off">
		  <tr>
            <td colspan="4">
...
" onClick="Confirmation('selMsgConfirm', 'msgConfirmform', Array('music_ids', 'action', 'confirmMessage'), Array('<?php echo $this->_tpl_vars['myobj']->getFormField('music_id'); ?>
...
<?php endif; ?>
<?php if ($this->_tpl_vars['myobj']->isShowPageBlock('list_flagged_music_form')): ?>
  <div id="selMusicList">
...
">
	      <tr>
			...
			<th><?php echo $this->_tpl_vars['LANG']['manageflagged_Music_title']; ?>
</th>
	        <th><?php echo $this->_tpl_vars['LANG']['manageflagged_user_name']; ?>
</th>
		...
		<?php $_from = $this->_tpl_vars['displayMusicList_arr']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['dalValue']):
?>
            <tr class="<?php echo $this->_tpl_vars['myobj']->getCSSRowClass(); ?>
">
              <td class="clsAlignCenter"><input type="checkbox" class="clsCheckRadio" name="music_ids[]" value="<?php echo $this->_tpl_vars['dalValue']['record']['music_id']; ?>
" tabindex="<?php echo smartyTabIndex(array(), $this);?>
" onClick="disableHeading('flaggedForm');" <?php echo $this->_tpl_vars['dalValue']['checked']; ?>
/></td>
              <td> <?php echo $this->_tpl_vars['dalValue']['record']['music_title']; ?>
</td>
              <td><?php echo $this->_tpl_vars['myobj']->getUserName($this->_tpl_vars['dalValue']['record']['user_id']); ?>
</td>
              <td><?php echo $this->_tpl_vars['myobj']->getCountOfRequests($this->_tpl_vars['dalValue']['record']['music_id']); ?>
</td>
              <td><span id="detail"><a href="?action=detail&amp;music_id=<?php echo $this->_tpl_vars['dalValue']['record']['music_id']; ?>
&amp;start=<?php echo $this->_tpl_vars['myobj']->getFormField('start'); ?>
"><?php echo $this->_tpl_vars['LANG']['manageflagged_detail']; ?>
</a></span>&nbsp;&nbsp;&nbsp;&nbsp;<span id="preview">
                    <a id="viewMusic_<?php echo $this->_tpl_vars['dalValue']['record']['music_id']; ?>
" href="<?php echo $this->_tpl_vars['CFG']['site']['url']; ?>
admin/music/musicPreview.php?music_id=<?php echo $this->_tpl_vars['dalValue']['record']['music_id']; ?>
" title="<?php echo $this->_tpl_vars['LANG']['manageflagged_preview_option']; ?>
"><?php echo $this->_tpl_vars['LANG']['manageflagged_preview_option']; ?>
   		 ...
   		 <?php endforeach; endif; unset($_from); ?>          
            <tr>
                <td colspan="5" class="<?php echo $this->_tpl_vars['myobj']->getCSSFormFieldCellClass('music_submit'); ?>
">
                    <a href="#" id="dAltMlti"></a>
...
" onClick="if(getMultiCheckBoxValue('flaggedForm', 'check_all', '<?php echo $this->_tpl_vars['LANG']['err_tip_select_Music']; ?>
', 'dAltMlti', -25, -290)) <?php echo ' { '; ?>
 Confirmation('selMsgConfirm', 'msgConfirmform', Array('music_ids', 'action', 'confirmMessage'), Array(multiCheckValue, 'Delete', '<?php echo $this->_tpl_vars['LANG']['delete_confirm_message']; ?>
...
" onClick="if(getMultiCheckBoxValue('flaggedForm', 'check_all', '<?php echo $this->_tpl_vars['LANG']['err_tip_select_Music']; ?>
', 'dAltMlti', -25, -290)) <?php echo ' { '; ?>
 Confirmation('selMsgConfirm', 'msgConfirmform', Array('music_ids', 'action', 'confirmMessage'), Array(multiCheckValue, 'Flag', '<?php echo $this->_tpl_vars['LANG']['flag_confirm_message']; ?>
'), Array('value', 'value', 'innerHTML'), -25, -290); <?php echo ' } '; ?>
" />
...
" onClick="if(getMultiCheckBoxValue('flaggedForm', 'check_all', '<?php echo $this->_tpl_vars['LANG']['err_tip_select_Music']; ?>
', 'dAltMlti', -25, -290)) <?php echo ' { '; ?>
 Confirmation('selMsgConfirm', 'msgConfirmform', Array('music_ids', 'action', 'confirmMessage'), Array(multiCheckValue, 'Unflag', '<?php echo $this->_tpl_vars['LANG']['unflag_confirm_message']; ?>
'), Array('value', 'value', 'innerHTML'), -25, -290); <?php echo ' } '; ?>
" />
                </td>
            </tr>
