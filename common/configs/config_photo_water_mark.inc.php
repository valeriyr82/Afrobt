 ...
 * @cfg_arr_key 	string
 */
$CFG['admin']['watermark']['water_mark_text_width']=75;
/**
 ...
 * @cfg_arr_key 	string
 */
$CFG['admin']['watermark']['water_mark_text_height']=25;
/**
 ...
 * @cfg_arr_key 	string
 */
$CFG['admin']['watermark']['water_mark_text_xposition']=25;
/**
 ...
 * @#cfg_arr_key 	string
 */
$CFG['admin']['watermark']['water_mark_type']='image';
/**
 ...
 * @#cfg_arr_key 	string
 */
$CFG['admin']['watermark']['water_mark_text_image_back_ground_color']='PeachPuff';
/**
 ...
 * @#cfg_arr_key 	string
 */
$CFG['admin']['watermark']['water_mark_text_image_text_color']='black';
/**
 ...
 * @#cfg_arr_key 	string
 */
$CFG['admin']['watermark']['water_mark_text_image_text']='Agriya';
