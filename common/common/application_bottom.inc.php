...
<script type="text/javascript">
  ...
  uv.src = 'http://t.afriville.com/'+'stickyfooter/js/apiwidget.js';
...
/* if(typeof $Jq.fn.fancybox === 'undefined')
{
    loadjsfile("http://customers.agriya.com/js/lib/jQuery_plugins/jquery.fancybox.js");

}*/

</script>
<div id="widget-container" class="clsWidCont"></div>
<div id="sidewidget-container" class="clsWidCont"></div>
